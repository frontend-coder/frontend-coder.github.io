...
foreach ( $_POST as $key => $value ) {
	if ( $value != ""  && $key != "admin_email" && $key != "form_subject" ) {
		...
		$message .= "
		" . ( ($c = !$c) ? '<tr>':'<tr style="background-color: #eeeeee;">' ) . "
...
$message = "<table style='border: 1px solid #eeeeee; width: 50%;'>$message</table>";


// От кого
$mail->setFrom('adm@' . $_SERVER['HTTP_HOST'], 'Alfa Septik');
