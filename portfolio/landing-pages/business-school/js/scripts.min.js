...
;(function($,window,document,undefined){
  ...
  (function (e) {
    ...
    (f.prototype = {
      ...
      renderErrors() {
        ...
        for (const t in this.result) {
          ...
          if (
            ...
            const s = document.querySelector(`label[for="${n.getAttribute('id')}"]`);
            n.parentNode.tagName.toLowerCase() === 'label'
      ...
      hideTooltips() {
        const e = this;
        const t = document.querySelectorAll('.js-validate-error-label');
        t.forEach((t) => {
      ...
      lockForm() {
        for (let e = this.$form.querySelectorAll('input, textarea, button, select'), t = 0, i = e.length; t < i; ++t) {
      ...
      unlockForm() {
        for (let e = this.$form.querySelectorAll('input, textarea, button, select'), t = 0, i = e.length; t < i; ++t) e[t].removeAttribute('disabled'), (e[t].style.pointerEvents = ''), (e[t].style.webitFilter = ''), (e[t].style.filter = '');
      },
    }),
    (e.JustValidate = f);
  }(window));
